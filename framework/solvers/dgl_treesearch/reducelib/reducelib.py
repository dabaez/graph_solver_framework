...
class reducelib:
    ...
    def unweighted_reduce_graph(self, g) -> Tuple[int, np.ndarray]:
        ...
        # Call library
        crt_is_size = self.unweighted_lib.UnweightedReduce(
            n_nodes, n_edges, e_froms, e_tos, reduction_result
        )
    ...
    def unweighted_local_search(self, g):
        ...
        self.unweighted_lib.UnweightedLocalSearch(
            n_nodes, n_edges, e_froms, e_tos, init_mis, final_mis
        )
    ...
    def weighted_reduce_graph(self, g):
        ...
        # Call library
        crt_is_weight = self.weighted_lib.WeightedReduce(
            n_nodes, n_edges, e_froms, e_tos, node_weights, reduction_result
        )
    ...
    def weighted_local_search(self, g):
        ...
        self.weighted_lib.WeightedLocalSearch(
            n_nodes, n_edges, e_froms, e_tos, node_weights, init_mis, final_mis
        )
        indset = np.asarray(final_mis[:])
